...
contract BaseUpgradeableStrategyStorage is ControllableInit {
    ...
    bytes32 internal constant _REWARD_TOKENS_SLOT =
        0x45418d9b5c2787ae64acbffccad43f2b487c1a16e24385aa9d2b059f9d1d163c;
    ...
    bytes32 internal constant _STRATEGIST_SLOT =
        0x6a7b588c950d46e2de3db2f157e5e0e4f29054c8d60f17bf0c30352e223a458d;
    ...
    constructor() {
        ...
        assert(
            _REWARD_TOKENS_SLOT ==
                bytes32(
                    uint256(keccak256("eip1967.strategyStorage.rewardTokens")) -
                        1
                )
        );
        assert(
        ...
        assert(
            _STRATEGIST_SLOT ==
                bytes32(
                    uint256(keccak256("eip1967.strategyStorage.strategist")) - 1
                )
        );
    }
